...
public class DoubleHungarianDispatcher extends UniversalDispatcher {
    ...
    private DoubleHungarianDispatcher( //
        ...
        firstGroupSize = safeConfig.getInteger("firstGroupSize", 0);
        GlobalAssert.that(firstGroupSize != 0);
    ...
    Collection<VehicleLinkPair> supplier(int dispatcher) {
        GlobalAssert.that(dispatcher == 1 || dispatcher == 2);
        if (dispatcher == 1)
    ...
    public void redispatch(double now) {
        ...
        if (round_now % dispatchPeriod == 0) {
            ...
            Tensor pv1 = HungarianUtils.globalBipartiteMatching(this, () -> supplier(1));
            Tensor pv2 = HungarianUtils.globalBipartiteMatching(this, () -> supplier(2));
